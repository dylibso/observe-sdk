...
//    let (ctx, events_rx, events_tx) = InstrumentationContext::new(id);
    ...
    linker.func_new(
        ...
        move |_caller: Caller<T>, params, results| instrument_enter(params, results, ctx1.clone(), &function_names),
    )?;
    ...
    linker.func_new(
        ...
        move |_caller, params, results| instrument_exit( params, results, ctx2.clone()),
    )?;
    ...
    linker.func_new(
        ...
        move |_caller, params, results| {
            instrument_memory_grow(params, results, ctx3.clone())
        },
    )?;
